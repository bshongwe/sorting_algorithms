 ...
 *
 * Return: if s1 > s2 (positive byte difference),
 *         if s1 == s2 (0),
 *         if s1 < s2 (negative byte difference)
 */
...
/**
 * get_val - Func gets numerical value of card.
...
/**
 * insertion_sort_deck_kind - Func sorts deck of cards
 * from spades to diamonds.
 * @deck: Head pointer to the head of a deck_node_t doubly-linked list.
 */
